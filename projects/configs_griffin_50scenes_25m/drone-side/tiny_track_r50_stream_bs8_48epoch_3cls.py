...
save_track_query_file_root = f'./data/infos/{dataset_prefix}/{v2x_side}/track_query/'
...
# 实际数据位置
data_root = f"/data2/liqizhe/griffin_dataset/griffin25m/{dataset_prefix}/griffin-nuscenes/{v2x_side}/"
...
log_config = dict(
    ...
    hooks=[
        ...
        dict(
            ...
            init_kwargs=dict(
                project='griffin',
                name=f'{dataset_prefix}_{v2x_side}_tiny_r50_bs{batch_size}x{num_gpus}_{num_epochs}e_3cls_minZ{point_cloud_range[2]}',
            ),
        ),
    ],
)
